local level = {
    identifier = "Temple-1",      -- change to a unique identifier
    title = "Temple-1",            -- level title
    theme = THEME.TEMPLE,         -- must match selected level's theme
    width = 4,                  -- must match level width
    height = 4,                 -- must match level height
    file_name = "Temple-1.lvl",-- must match .lvl filename
}
