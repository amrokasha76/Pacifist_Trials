local level = {
    identifier = "ephemeral",      -- change to a unique identifier
    title = "Ephemeral (Jawn)",            -- level title
    theme = THEME.JUNGLE,         -- must match selected level's theme
    width = 4,                  -- must match level width
    height = 2,                 -- must match level height
    file_name = "ephemeral.lvl", -- must match .lvl filename
}
