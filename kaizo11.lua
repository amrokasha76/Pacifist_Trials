local level = {
    identifier = "rebound",      -- change to a unique identifier
    title = "Rebound (Jawn)",            -- level title
    theme = THEME.DWELLING,         -- must match selected level's theme
    width = 2,                  -- must match level width
    height = 2,                 -- must match level height
    file_name = "rebound.lvl",    -- must match .lvl filename
}
