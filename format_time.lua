...
local function format_time(frames, include_milliseconds)
    ...
    return hours_text .. minutes_text .. tostring(minutes % 60) .. ':' ..
               seconds_text ..
               string.format((include_milliseconds and "%.3f" or "%.0f"),
                             seconds % 60)
end
