local level = {
    identifier = "Volcana-2",      -- change to a unique identifier
    title = "Volcana-2",            -- level title
    theme = THEME.VOLCANA,         -- must match selected level's theme
    width = 4,                  -- must match level width
    height = 7,                 -- must match level height
    file_name = "Volcana-2.lvl",-- must match .lvl filename
}
