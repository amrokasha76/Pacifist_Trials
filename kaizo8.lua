local level = {
    identifier = "bait",      -- change to a unique identifier
    title = "Bait (Jawn)",            -- level title
    theme = THEME.TIDE_POOL,         -- must match selected level's theme
    width = 3,                  -- must match level width
    height = 2,                 -- must match level height
    file_name = "bait.lvl", -- must match .lvl filename
}
